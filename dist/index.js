...
},{"./lib/axios":"../node_modules/axios/lib/axios.js"}],"js/alert.js":[function(require,module,exports) {
"use strict";
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            (0, _alert.showAlert)('error', 'Unable to logout. Please try again later.');
...
},{"axios":"../node_modules/axios/index.js","./alert":"js/alert.js"}],"js/updateData.js":[function(require,module,exports) {
"use strict";
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === 'password' ? '/api/v1/users/updatePassword' : '/api/v1/users/updateSelf';
            _context.next = 4;
            return (0, _axios.default)({
              method: 'PATCH',
              url: url,
          ...
          case 8:
            ...
            (0, _alert.showAlert)('error', 'Unable to update. Please try again later.');
...
},{"axios":"../node_modules/axios/index.js","./alert":"js/alert.js"}],"js/mapbox.js":[function(require,module,exports) {
"use strict";
...
var renderSpinner = function renderSpinner(form) {
  var parentContainer = document.querySelector('.renderSpinner');
...
var _updateData = require("./js/updateData");
...
var formPasswordInnerHtml = document.querySelector('.form-user-password');
var formDataInnerHtml = document.querySelector('.form-user-data');
var parentContainer = document.querySelector('.renderSpinner'); // DELEGATION
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              e.preventDefault();
              (0, _spinner.renderSpinner)(formDataInnerHtml);
              form = new FormData();
              form.append('name', document.getElementById('name').value);
              form.append('email', document.getElementById('email').value); // Files are an array: Theres only one in the array

              form.append('photo', document.getElementById('photo').files[0]);
              console.log(form);
              _context.next = 9;
              return (0, _updateData.updateData)(form, 'data');
      ...
      return regeneratorRuntime.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              e.preventDefault();
              (0, _spinner.renderSpinner)(formPasswordInnerHtml);
